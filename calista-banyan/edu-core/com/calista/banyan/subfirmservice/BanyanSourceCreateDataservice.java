...
/**
 * 
 * BanyanSourceCreateDataservice.
 *
 * @author Hien Nguyen
 * @version $Id: BanyanSourceCreateDataservice.java Oct 13, 2020 4:08:11 PM nguyen_dv $
 *
 * @since 1.0
 */
@Named("banyansourcecreate")
@XPortalDataService(roles={BanyanConstant.ROLE_ADMIN}, description="Banyan Source service")
@XPortalPageRequest(uri="banyan/source/create", 
	inherit = true,
	transaction = true,
	result = WebConstant.ACTION_XSTREAM_JSON_RESULT)
public class BanyanSourceCreateDataservice extends PluginSubfirmAbstraction {
	@Inject
	...
	{
		GlbSource model = action.getModel(GlbSource.class, params);
		model.setOrganId(getOrganId(site, firm));
